...
<body style = "background-color: grey; font-family: 'assistant';">
	<div class = "studentpage">
		...
		<div class = "panel-top">
			...
			?>
		<div class = "box">	
			<div class='upload'><input type='button' class='uploadbtn' value='Upload' onclick='document.location.href = "upload.php"'/></div>
		</div>
		...
		<div class = "panel-Subjects">
				...
				$sql = "SELECT * FROM tblgrd ORDER BY SY asc";
